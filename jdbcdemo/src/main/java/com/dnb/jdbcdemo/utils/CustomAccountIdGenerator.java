...
public class CustomAccountIdGenerator extends SequenceStyleGenerator {
	...
	@Override
	public Object generate(SharedSessionContractImplementor session, Object object) throws HibernateException //generates the id 
	{
	...
	{
		// TODO Auto-generated method stub
		super.configure(new TypeConfiguration().getBasicTypeRegistry().getRegisteredType(long.class), parameters, serviceRegistry);    //tell jpa to convert to long value
